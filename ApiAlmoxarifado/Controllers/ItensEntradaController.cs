    ...
    public class ItensEntradaController:Controller
    {
        ...
        public IActionResult AdicionarDepartamento(ItensEntrada produto)
        {
            try
            {
                ...
                (
                new ItensEntrada() { Codigo = produto.Codigo, codigoEntrada = produto.codigoEntrada, estoque = produto.estoque,
                    codigoProduto = produto.codigoProduto, entrada_id = produto.entrada_id }
                );
